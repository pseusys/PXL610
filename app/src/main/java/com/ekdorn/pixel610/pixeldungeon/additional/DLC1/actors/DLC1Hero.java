 ...
 */
package com.ekdorn.pixel610.pixeldungeon.additional.DLC1.actors;
...
import com.ekdorn.pixel610.pixeldungeon.actors.buffs.Combo;
...
import com.ekdorn.pixel610.pixeldungeon.actors.buffs.Regeneration;
import com.ekdorn.pixel610.pixeldungeon.actors.buffs.Roots;
import com.ekdorn.pixel610.pixeldungeon.actors.buffs.SnipersMark;
...
import com.ekdorn.pixel610.pixeldungeon.actors.hero.HeroAction;
...
import com.ekdorn.pixel610.pixeldungeon.effects.CheckedCell;
import com.ekdorn.pixel610.pixeldungeon.effects.Flare;
import com.ekdorn.pixel610.pixeldungeon.effects.Speck;
import com.ekdorn.pixel610.pixeldungeon.items.Amulet;
...
import com.ekdorn.pixel610.pixeldungeon.items.keys.GoldenKey;
...
import com.ekdorn.pixel610.pixeldungeon.items.rings.RingOfAccuracy;
import com.ekdorn.pixel610.pixeldungeon.items.rings.RingOfDetection;
import com.ekdorn.pixel610.pixeldungeon.items.rings.RingOfElements;
import com.ekdorn.pixel610.pixeldungeon.items.rings.RingOfEvasion;
import com.ekdorn.pixel610.pixeldungeon.items.rings.RingOfHaste;
...
import com.ekdorn.pixel610.pixeldungeon.items.weapon.melee.MeleeWeapon;
...
import com.ekdorn.pixel610.pixeldungeon.levels.features.AlchemyPot;
import com.ekdorn.pixel610.pixeldungeon.levels.features.Chasm;
import com.ekdorn.pixel610.pixeldungeon.levels.features.Sign;
...
import com.ekdorn.pixel610.pixeldungeon.scenes.SurfaceScene;
import com.ekdorn.pixel610.pixeldungeon.sprites.CharSprite;
import com.ekdorn.pixel610.pixeldungeon.sprites.HeroSprite;
import com.ekdorn.pixel610.pixeldungeon.ui.AttackIndicator;
...
import com.ekdorn.pixel610.pixeldungeon.windows.WndTradeItem;
...
public class DLC1Hero extends Hero {
	...
	public DLC1HeroClass heroClass = DLC1HeroClass.FEMALE;
	...
	public void restoreFromBundle( Bundle bundle ) {
		...
		heroClass = DLC1HeroClass.restoreInBundle( bundle );
	...
	public int defenseSkill( Char enemy ) {
		...
		if (aEnc > 0) {
			...
			if (heroClass == DLC1HeroClass.MALE) {
	...
	void updateAwareness() {
		awareness = (float)(1 - Math.pow(
			(heroClass == DLC1HeroClass.MALE ? 0.85 : 0.90),
