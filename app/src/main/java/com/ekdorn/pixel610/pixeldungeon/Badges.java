...
import com.ekdorn.pixel610.pixeldungeon.actors.mobs.Acidic;
import com.ekdorn.pixel610.pixeldungeon.actors.mobs.Albino;
import com.ekdorn.pixel610.pixeldungeon.actors.mobs.Bandit;
import com.ekdorn.pixel610.pixeldungeon.actors.mobs.Mob;
import com.ekdorn.pixel610.pixeldungeon.actors.mobs.Senior;
import com.ekdorn.pixel610.pixeldungeon.actors.mobs.Shielded;
...
import com.ekdorn.pixel610.pixeldungeon.items.bags.WandHolster;
...
public class Badges {
	...
	public static enum Badge {
		MONSTERS_SLAIN_1(Babylon.get().getFromResources("badges_10enemies"), 0 ),
		MONSTERS_SLAIN_2(Babylon.get().getFromResources("badges_50enemies"), 1 ),
		MONSTERS_SLAIN_3(Babylon.get().getFromResources("badges_150enemies"), 2 ),
		MONSTERS_SLAIN_4(Babylon.get().getFromResources("badges_250enemies"), 3 ),
		GOLD_COLLECTED_1(Babylon.get().getFromResources("badges_100gold"), 4 ),
		GOLD_COLLECTED_2(Babylon.get().getFromResources("badges_500gold"), 5 ),
		GOLD_COLLECTED_3(Babylon.get().getFromResources("badges_2500gold"), 6 ),
		GOLD_COLLECTED_4(Babylon.get().getFromResources("badges_7500gold"), 7 ),
		LEVEL_REACHED_1(Babylon.get().getFromResources("badges_6level"), 8 ),
		...
		ALL_BAGS_BOUGHT(Babylon.get().getFromResources("badges_bags"), 23 ),
		DEATH_FROM_FIRE(Babylon.get().getFromResources("badges_death_fire"), 24 ),
		DEATH_FROM_POISON(Babylon.get().getFromResources("badges_death_poison"), 25 ),
		DEATH_FROM_GAS(Babylon.get().getFromResources("badges_death_gas"), 26 ),
		DEATH_FROM_HUNGER(Babylon.get().getFromResources("badges_death_hunger"), 27 ),
		DEATH_FROM_GLYPH(Babylon.get().getFromResources("badges_death_glyph"), 57 ),
		DEATH_FROM_FALLING(Babylon.get().getFromResources("badges_death_falling"), 59 ),
		YASD(Babylon.get().getFromResources("badges_death_everything"), 34, true ),
		BOSS_SLAIN_1_WARRIOR,
		BOSS_SLAIN_1_MAGE,
		BOSS_SLAIN_1_ROGUE,
		BOSS_SLAIN_1_HUNTRESS,
		BOSS_SLAIN_1(Babylon.get().getFromResources("badges_1boss"), 12 ),
		BOSS_SLAIN_2(Babylon.get().getFromResources("badges_2boss"), 13 ),
		BOSS_SLAIN_3(Babylon.get().getFromResources("badges_3boss"), 14 ),
		BOSS_SLAIN_4(Babylon.get().getFromResources("badges_4boss"), 15 ),
		BOSS_SLAIN_1_ALL_CLASSES(Babylon.get().getFromResources("badges_1boss_everyone"), 32, true ),
		...
		BOSS_SLAIN_3_SNIPER,
		BOSS_SLAIN_3_WARDEN,
		BOSS_SLAIN_3_ALL_SUBCLASSES(Babylon.get().getFromResources("badges_3boss_everyone"), 33, true ),
		RING_OF_HAGGLER(Babylon.get().getFromResources("badges_hagglerring"), 20 ),
		RING_OF_THORNS(Babylon.get().getFromResources("badges_thornsring"), 21 ),
		STRENGTH_ATTAINED_1(Babylon.get().getFromResources("badges_13strength"), 40 ),
		STRENGTH_ATTAINED_2(Babylon.get().getFromResources("badges_15strength"), 41 ),
		STRENGTH_ATTAINED_3(Babylon.get().getFromResources("badges_17strength"), 42 ),
		STRENGTH_ATTAINED_4(Babylon.get().getFromResources("badges_19strength"), 43 ),
		FOOD_EATEN_1(Babylon.get().getFromResources("badges_10food"), 44 ),
		FOOD_EATEN_2(Babylon.get().getFromResources("badges_20food"), 45 ),
		FOOD_EATEN_3(Babylon.get().getFromResources("badges_30food"), 46 ),
		FOOD_EATEN_4(Babylon.get().getFromResources("badges_40food"), 47 ),
		MASTERY_WARRIOR,
		MASTERY_MAGE,
		MASTERY_ROGUE,
		MASTERY_HUNTRESS,
		ITEM_LEVEL_1(Babylon.get().getFromResources("badges_item3"), 48 ),
		ITEM_LEVEL_2(Babylon.get().getFromResources("badges_item6"), 49 ),
		ITEM_LEVEL_3(Babylon.get().getFromResources("badges_item9"), 50 ),
		ITEM_LEVEL_4(Babylon.get().getFromResources("badges_item12"), 51 ),
		RARE_ALBINO,
		RARE_BANDIT,
		RARE_SHIELDED,
		RARE_SENIOR,
		RARE_ACIDIC,
		RARE(Babylon.get().getFromResources("badges_raremonsters"), 37, true ),
		VICTORY_WARRIOR,
		VICTORY_MAGE,
		VICTORY_ROGUE,
		VICTORY_HUNTRESS,
		VICTORY(Babylon.get().getFromResources("badges_victory"), 22 ),
		VICTORY_ALL_CLASSES(Babylon.get().getFromResources("badges_victory_all"), 36, true ),
		MASTERY_COMBO(Babylon.get().getFromResources("badges_7hitcombo"), 56 ),
		POTIONS_COOKED_1(Babylon.get().getFromResources("bodges_3potions"), 52 ),
		POTIONS_COOKED_2(Babylon.get().getFromResources("bodges_6potions"), 53 ),
		POTIONS_COOKED_3(Babylon.get().getFromResources("bodges_9potions"), 54 ),
		POTIONS_COOKED_4(Babylon.get().getFromResources("bodges_12potions"), 55 ),
		NO_MONSTERS_SLAIN(Babylon.get().getFromResources("badges_nomonsters"), 28 ),
		GRIM_WEAPON(Babylon.get().getFromResources("badges_grim"), 29 ),
		PIRANHAS(Babylon.get().getFromResources("badges_piranhas"), 30 ),
		NIGHT_HUNTER(Babylon.get().getFromResources("badges_15atnight"), 58 ),
		GAMES_PLAYED_1(Babylon.get().getFromResources("badges_10games"), 60, true ),
		GAMES_PLAYED_2(Babylon.get().getFromResources("badges_100games"), 61, true ),
		GAMES_PLAYED_3(Babylon.get().getFromResources("badges_500games"), 62, true ),
		GAMES_PLAYED_4(Babylon.get().getFromResources("badges_2000games"), 63, true ),
		HAPPY_END(Babylon.get().getFromResources("badges_happyend"), 38 ),
		CHAMPION(Babylon.get().getFromResources("badges_challenge"), 39, true ),
		SUPPORTER(Babylon.get().getFromResources("badges_donation"), 31, true );
	...
	private static void displayBadge( Badge badge ) {
		...
		if (global.contains( badge )) {
			...
			if (!badge.meta) {
				GLog.h(Babylon.get().getFromResources("badges_endorsed"), badge.description );
			}
			...
			if (badge.meta) {
				GLog.h(Babylon.get().getFromResources("badges_newsuper"), badge.description );
			} else {
				GLog.h(Babylon.get().getFromResources("badges_new"), badge.description );
			}	
