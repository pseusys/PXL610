...
import com.ekdorn.pixel610.classicdungeon.actors.mobs.Yog.BurningFist;
import com.ekdorn.pixel610.classicdungeon.actors.mobs.Yog.RottingFist;
...
public class Bestiary {
	...
	private static Class<?> mobClass( int depth ) {
		...
		case 8:
			...
			classes = new Class<?>[]{ Skeleton.class, Shaman.class, Thief.class, Swarm.class,   /*Bat.class*/ };
			break;
		case 9:
