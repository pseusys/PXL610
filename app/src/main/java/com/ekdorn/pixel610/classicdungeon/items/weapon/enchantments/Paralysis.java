...
public class Paralysis extends Weapon.Enchantment {
	...
	public boolean proc( Weapon weapon, Char attacker, Char defender, int damage ) {
		...
		if (Random.Int( level + 8 ) >= 7) {
			...
			Buff.prolong( defender, com.ekdorn.pixel610.classicdungeon.actors.buffs.Paralysis.class,
	...
	public String name( String weaponName) {
		return String.format( Babylon.get().getFromResources("enchantment_stunning"), weaponName );
	}
