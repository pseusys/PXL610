...
public class PotionOfMight extends PotionOfStrength {
	...
	@Override
	public void finish() {
		name = Babylon.get().getFromResources("potion_might");
	}
	...
	protected void apply( Hero hero ) {
		...
		hero.HT += 5;
		hero.HP += 5;
		hero.sprite.showStatus( CharSprite.POSITIVE, Babylon.get().getFromResources("potion_might_bonus"));
		GLog.p(Babylon.get().getFromResources("potion_might_apply"));
