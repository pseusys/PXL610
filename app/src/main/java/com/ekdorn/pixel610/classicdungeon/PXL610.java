...
import com.ekdorn.pixel610.classicdungeon.scenes.TitleScene;
import com.ekdorn.pixel610.classicdungeon.windows.WndSettings;
...
public class PXL610 extends Game {
	...
	public PXL610() {
		...
		com.ekdorn.pixel610.utils.Bundle.addAlias(
			com.ekdorn.pixel610.classicdungeon.items.scrolls.ScrollOfUpgrade.class,
			"com.watabou.pixeldungeon.items.scrolls.ScrollOfEnhancement" );
		com.ekdorn.pixel610.utils.Bundle.addAlias(
			com.ekdorn.pixel610.classicdungeon.actors.blobs.WaterOfHealth.class,
			"com.watabou.pixeldungeon.actors.blobs.Light" );
		com.ekdorn.pixel610.utils.Bundle.addAlias(
			com.ekdorn.pixel610.classicdungeon.items.rings.RingOfMending.class,
			"com.watabou.pixeldungeon.items.rings.RingOfRejuvenation" );
		com.ekdorn.pixel610.utils.Bundle.addAlias(
			com.ekdorn.pixel610.classicdungeon.items.wands.WandOfReach.class,
			"com.watabou.pixeldungeon.items.wands.WandOfTelekenesis" );
		com.ekdorn.pixel610.utils.Bundle.addAlias(
			com.ekdorn.pixel610.classicdungeon.actors.blobs.Foliage.class,
			"com.watabou.pixeldungeon.actors.blobs.Blooming" );
		com.ekdorn.pixel610.utils.Bundle.addAlias(
			com.ekdorn.pixel610.classicdungeon.actors.buffs.Shadows.class,
			"com.watabou.pixeldungeon.actors.buffs.Rejuvenation" );
		com.ekdorn.pixel610.utils.Bundle.addAlias(
			com.ekdorn.pixel610.classicdungeon.items.scrolls.ScrollOfPsionicBlast.class,
			"com.watabou.pixeldungeon.items.scrolls.ScrollOfNuclearBlast" );
		com.ekdorn.pixel610.utils.Bundle.addAlias(
			com.ekdorn.pixel610.classicdungeon.actors.hero.Hero.class,
			"com.watabou.pixeldungeon.actors.Hero" );
		com.ekdorn.pixel610.utils.Bundle.addAlias(
			com.ekdorn.pixel610.classicdungeon.actors.mobs.npcs.Shopkeeper.class,
			"com.watabou.pixeldungeon.actors.mobs.Shopkeeper" );
		// 1.6.1
		com.ekdorn.pixel610.utils.Bundle.addAlias(
			com.ekdorn.pixel610.classicdungeon.items.quest.DriedRose.class,
			"com.watabou.pixeldungeon.items.DriedRose" );
		com.ekdorn.pixel610.utils.Bundle.addAlias(
			com.ekdorn.pixel610.classicdungeon.actors.mobs.npcs.MirrorImage.class,
			"com.watabou.pixeldungeon.items.scrolls.ScrollOfMirrorImage$MirrorImage" );
		// 1.6.4
		com.ekdorn.pixel610.utils.Bundle.addAlias(
			com.ekdorn.pixel610.classicdungeon.items.rings.RingOfElements.class,
			"com.watabou.pixeldungeon.items.rings.RingOfCleansing" );
		com.ekdorn.pixel610.utils.Bundle.addAlias(
			com.ekdorn.pixel610.classicdungeon.items.rings.RingOfElements.class,
			"com.watabou.pixeldungeon.items.rings.RingOfResistance" );
		com.ekdorn.pixel610.utils.Bundle.addAlias(
			com.ekdorn.pixel610.classicdungeon.items.weapon.missiles.Boomerang.class,
			"com.watabou.pixeldungeon.items.weapon.missiles.RangersBoomerang" );
		com.ekdorn.pixel610.utils.Bundle.addAlias(
			com.ekdorn.pixel610.classicdungeon.items.rings.RingOfPower.class,
			"com.watabou.pixeldungeon.items.rings.RingOfEnergy" );
		// 1.7.2
		com.ekdorn.pixel610.utils.Bundle.addAlias(
			com.ekdorn.pixel610.classicdungeon.plants.Dreamweed.class,
			"com.watabou.pixeldungeon.plants.Blindweed" );
		com.ekdorn.pixel610.utils.Bundle.addAlias(
			com.ekdorn.pixel610.classicdungeon.plants.Dreamweed.Seed.class,
			"com.watabou.pixeldungeon.plants.Blindweed$Seed" );
		// 1.7.4
		com.ekdorn.pixel610.utils.Bundle.addAlias(
			com.ekdorn.pixel610.classicdungeon.items.weapon.enchantments.Shock.class,
			"com.watabou.pixeldungeon.items.weapon.enchantments.Piercing" );
		com.ekdorn.pixel610.utils.Bundle.addAlias(
			com.ekdorn.pixel610.classicdungeon.items.weapon.enchantments.Shock.class,
			"com.watabou.pixeldungeon.items.weapon.enchantments.Swing" );
		com.ekdorn.pixel610.utils.Bundle.addAlias(
			com.ekdorn.pixel610.classicdungeon.items.scrolls.ScrollOfEnchantment.class,
		...
		// 1.8.0
		com.ekdorn.pixel610.utils.Bundle.addAlias(
			com.ekdorn.pixel610.classicdungeon.actors.mobs.FetidRat.class,
			"com.watabou.pixeldungeon.actors.mobs.npcs.Ghost$FetidRat" );
		com.ekdorn.pixel610.utils.Bundle.addAlias(
			com.ekdorn.pixel610.classicdungeon.plants.Rotberry.class,
			"com.watabou.pixeldungeon.actors.mobs.npcs.Wandmaker$Rotberry" );
		com.ekdorn.pixel610.utils.Bundle.addAlias(
			com.ekdorn.pixel610.classicdungeon.plants.Rotberry.Seed.class,
