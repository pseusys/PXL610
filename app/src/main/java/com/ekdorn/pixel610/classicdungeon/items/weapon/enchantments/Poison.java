...
public class Poison extends Weapon.Enchantment {
	...
	public boolean proc( Weapon weapon, Char attacker, Char defender, int damage ) {
		...
		if (Random.Int( level + 3 ) >= 2) {
			...
			Buff.affect( defender, com.ekdorn.pixel610.classicdungeon.actors.buffs.Poison.class ).
				set( com.ekdorn.pixel610.classicdungeon.actors.buffs.Poison.durationFactor( defender ) * (level + 1) );
	...
	public String name( String weaponName) {
		return String.format( Babylon.get().getFromResources("enchantment_venomous"), weaponName );
	}
