...
public class AmuletScene extends PixelScene {
	...
	public void create() {
		...
		RedButton btnExit = new RedButton( Babylon.get().getFromResources("amuletscene_exit") ) {
			@Override
		...
		RedButton btnStay = new RedButton( Babylon.get().getFromResources("amuletscene_stay") ) {
			@Override
			protected void onClick() {
				onBackPressed();
			}
